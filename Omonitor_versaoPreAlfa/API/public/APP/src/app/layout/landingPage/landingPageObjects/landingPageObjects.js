...
export const fillGridClasses=[
                {
                    text:"Matemática",
                    iconPath: GetPath.getcalculate_24dp_FFFFFF()
                },
                {
                    text:"Estatìstica",
                    iconPath: GetPath.getfinanceMode_24dp_FFFFFF()
                },
                {
                    text:"Legislação",
                    iconPath: GetPath.getaccountBalance_24dp_FFFFFF()
                },
                {
                    text:"Português",
                    iconPath: GetPath.getmenuBook_24dp_FFFFFF()
                },
                {
                    text:"Raciocínio Lógico",
                    iconPath: GetPath.getneurology_24dp_FFFFFF()
                },
                {
                    text:"Conhecimentos Bancários",
                    iconPath: GetPath.getbalance_24dp_FFFFFF()
                },
                {
                    text:"Atendimento \nBancário",
                    iconPath: GetPath.getconcierge_24dp_FFFFFF()
                },
                {
                    text:"Noções de Informática",
                    iconPath: GetPath.getdesktopWindows_24dp_FFFFFF()
                }
