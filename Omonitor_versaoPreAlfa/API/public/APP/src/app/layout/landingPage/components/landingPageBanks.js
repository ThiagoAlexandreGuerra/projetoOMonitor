...
import { fillGridClasses }        from "../landingPageObjects/landingPageObjects.js";
...
import { landingPageBanksInfoText } from "../landingPageObjects/landingPageObjects.js";
...
export default function landingPageBanks(navigation){
            ...
            .setBackgroundColor("inert")
                ...
                gridClasses.gridElements.forEach((component)=>{
                    component
                        ...
                        .setDisplay("flex")
                        .setPadding("0px")
                        ._addEventListener("click" , navigation.goTo(questionConsole))
    ...
    const editalBox = new StandartBox()
    ._removeStandardPosition()
    .setWidth("90%")
    .setBackgroundColor("rgba(0,0,0,0.5)")
    .setTextContent(
